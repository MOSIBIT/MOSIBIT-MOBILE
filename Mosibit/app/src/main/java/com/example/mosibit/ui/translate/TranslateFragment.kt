...
class TranslateFragment : Fragment() {
    ...
    private fun packetCallback() {
        ...
        processor.addPacketCallback(
            ...
            listWristX.add(wristX * widthRatio)
            listWristY.add(wristY * heightRatio)

            listThumbCmcX.add(thumbCmcX * widthRatio)
            listThumbCmcY.add(thumbCmcY * heightRatio)
            listThumbMcpX.add(thumbMcpX * widthRatio)
            listThumbMcpY.add(thumbMcpY * heightRatio)
            listThumbIpX.add(thumbIpX * widthRatio)
            listThumbIpY.add(thumbIpY * heightRatio)
            listThumbTipX.add(thumbTipX * widthRatio)
            listThumbTipY.add(thumbTipY * heightRatio)

            listIndexFingerMcpX.add(indexFingerMcpX * widthRatio)
            listIndexFingerMcpY.add(indexFingerMcpY * heightRatio)
            listIndexFingerPipX.add(indexFingerPipX * widthRatio)
            listIndexFingerPipY.add(indexFingerPipY * heightRatio)
            listIndexFingerDipX.add(indexFingerDipX * widthRatio)
            listIndexFingerDipY.add(indexFingerDipY * heightRatio)
            listIndexFingerTipX.add(indexFingerTipX * widthRatio)
            listIndexFingerTipY.add(indexFingerTipY * heightRatio)

            listMiddleFingerMcpX.add(middleFingerMcpX * widthRatio)
            listMiddleFingerMcpY.add(middleFingerMcpY * heightRatio)
            listMiddleFingerPipX.add(middleFingerPipX * widthRatio)
            listMiddleFingerPipY.add(middleFingerPipY * heightRatio)
            listMiddleFingerDipX.add(middleFingerDipX * widthRatio)
            listMiddleFingerDipY.add(middleFingerDipY * heightRatio)
            listMiddleFingerTipX.add(middleFingerTipX * widthRatio)
            listMiddleFingerTipY.add(middleFingerTipY * heightRatio)

            listRingFingerMcpX.add(ringFingerMcpX * widthRatio)
            listRingFingerMcpY.add(ringFingerMcpY * heightRatio)
            listRingFingerPipX.add(ringFingerPipX * widthRatio)
            listRingFingerPipY.add(ringFingerPipY * heightRatio)
            listRingFingerDipX.add(ringFingerDipX * widthRatio)
            listRingFingerDipY.add(ringFingerDipY * heightRatio)
            listRingFingerTipX.add(ringFingerTipX * widthRatio)
            listRingFingerTipY.add(ringFingerTipY * heightRatio)

            listPinkyMcpX.add(pinkyMcpX * widthRatio)
            listPinkyMcpY.add(pinkyMcpY * heightRatio)
            listPinkyPipX.add(pinkyPipX * widthRatio)
            listPinkyPipY.add(pinkyPipY * heightRatio)
            listPinkyDipX.add(pinkyDipX * widthRatio)
